...
namespace Rendering
{
	...
	void CubeDemo::Initialize()
	{
		...
		{
				VertexPositionColor(XMFLOAT4(-0.25f, 0.25f, -0.25f, 1.0f), XMFLOAT4(&Colors::Red[0])),
				VertexPositionColor(XMFLOAT4(0.25f, 0.25f, -0.25f, 1.0f), XMFLOAT4(&Colors::Green[0])),
				VertexPositionColor(XMFLOAT4(0.25f, 0.25f, 0.25f, 1.0f), XMFLOAT4(&Colors::Blue[0])),
				VertexPositionColor(XMFLOAT4(-0.25f, 0.25f, 0.25f, 1.0f), XMFLOAT4(&Colors::Orange[0])),
				VertexPositionColor(XMFLOAT4(-0.25f, -0.25f, 0.25f, 1.0f), XMFLOAT4(&Colors::Purple[0])),
				VertexPositionColor(XMFLOAT4(0.25f, -0.25f, 0.25f, 1.0f), XMFLOAT4(&Colors::Yellow[0])),
				VertexPositionColor(XMFLOAT4(0.25f, -0.25f, -0.25f, 1.0f), XMFLOAT4(&Colors::Black[0])),
				VertexPositionColor(XMFLOAT4(-0.25f, -0.25f, -0.25f, 1.0f), XMFLOAT4(&Colors::Brown[0]))
		};
