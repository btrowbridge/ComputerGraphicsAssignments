...
namespace Rendering
{
	PointLightDemo::PointLightDemo(Library::Game & game) :
	...
	void PointLightDemo::SetDirectionLight(float x, float y, float z) {
		mCBufferPerFramePS.DirectionLight = XMFLOAT4(x, y, z, 0.0f);
		mGame->Direct3DDeviceContext()->UpdateSubresource(mConstantBufferPerFramePS.Get(), 0, nullptr, &mCBufferPerFramePS, 0, 0);
	}
	void PointLightDemo::SetAmbientColor(float r, float b, float g, float a) {
		mCBufferPerFramePS.AmbientColor = XMFLOAT4(r, b, g, a);
		mGame->Direct3DDeviceContext()->UpdateSubresource(mConstantBufferPerFramePS.Get(), 0, nullptr, &mCBufferPerFramePS, 0, 0);
	}
	void PointLightDemo::SetAnimationEnabled(bool isEnabled)
	{
		mAnimationEnabled = isEnabled;
	}

	bool PointLightDemo::AnimationEnabled()
	{
	...
	void PointLightDemo::Draw(const Library::GameTime & gameTime)
	{
	...
	void PointLightDemo::Update(const Library::GameTime & gameTime)
	{
