...
namespace Rendering
{
	SpotlightDemo::SpotlightDemo(Library::Game & game) :
	...
	void SpotlightDemo::SetDirectionLight(float x, float y, float z) {
		mCBufferPerFramePS.DirectionLight = XMFLOAT4(x, y, z, 0.0f);
		mGame->Direct3DDeviceContext()->UpdateSubresource(mConstantBufferPerFramePS.Get(), 0, nullptr, &mCBufferPerFramePS, 0, 0);
	}
	void SpotlightDemo::SetAmbientColor(float r, float b, float g, float a) {
		mCBufferPerFramePS.AmbientColor = XMFLOAT4(r, b, g, a);
		mGame->Direct3DDeviceContext()->UpdateSubresource(mConstantBufferPerFramePS.Get(), 0, nullptr, &mCBufferPerFramePS, 0, 0);
	}
	void SpotlightDemo::SetAnimationEnabled(bool isEnabled)
	{
		mAnimationEnabled = isEnabled;
	}

	bool SpotlightDemo::AnimationEnabled()
	{
		return mAnimationEnabled;
	}

	void SpotlightDemo::CreateVertexBuffer(ID3D11Device* device, const Mesh& mesh, ID3D11Buffer** vertexBuffer) const {
	...
	void SpotlightDemo::Draw(const Library::GameTime & gameTime)
	{
	...
	void SpotlightDemo::Update(const Library::GameTime & gameTime)
	{
