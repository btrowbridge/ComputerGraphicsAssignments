...
namespace Rendering
{
	class SpotlightDemo : public Library::DrawableGameComponent
	{
	public:
		SpotlightDemo(Library::Game& game);
		SpotlightDemo(Game & game, const std::shared_ptr<Library::Camera>& camera);
