...
namespace Library
{
	...
	void SamplerStates::Initialize(ID3D11Device* direct3DDevice)
	{
		...
		ThrowIfFailed(direct3DDevice->CreateSamplerState(&samplerStateDesc, TrilinearWrap.GetAddressOf()), "ID3D11Device::CreateSamplerState() failed.");
		...
		ThrowIfFailed(direct3DDevice->CreateSamplerState(&samplerStateDesc, TrilinearMirror.GetAddressOf()), "ID3D11Device::CreateSamplerState() failed.");

		samplerStateDesc.Filter = D3D11_FILTER_MIN_MAG_MIP_LINEAR;
		samplerStateDesc.AddressU = D3D11_TEXTURE_ADDRESS_CLAMP;
		samplerStateDesc.AddressV = D3D11_TEXTURE_ADDRESS_CLAMP;
		samplerStateDesc.AddressW = D3D11_TEXTURE_ADDRESS_CLAMP;
		ThrowIfFailed(direct3DDevice->CreateSamplerState(&samplerStateDesc, TrilinearClamp.GetAddressOf()), "ID3D11Device::CreateSamplerState() failed.");
		...
		ThrowIfFailed(direct3DDevice->CreateSamplerState(&samplerStateDesc, TrilinerBorder.GetAddressOf()), "ID3D11Device::CreateSamplerState() failed.");

		samplerStateDesc.Filter = D3D11_FILTER_MIN_MAG_MIP_POINT;
		samplerStateDesc.AddressU = D3D11_TEXTURE_ADDRESS_CLAMP;
		samplerStateDesc.AddressV = D3D11_TEXTURE_ADDRESS_CLAMP;
		samplerStateDesc.AddressW = D3D11_TEXTURE_ADDRESS_CLAMP;
		ThrowIfFailed(direct3DDevice->CreateSamplerState(&samplerStateDesc, PointClamp.GetAddressOf()), "ID3D11Device::CreateSamplerState() failed.");
		...
		samplerStateDesc.AddressW = D3D11_TEXTURE_ADDRESS_BORDER;
		memcpy(samplerStateDesc.BorderColor, reinterpret_cast<FLOAT*>(&BorderColor), sizeof(FLOAT) * 4);
		ThrowIfFailed(direct3DDevice->CreateSamplerState(&samplerStateDesc, DepthMap.GetAddressOf()), "ID3D11Device::CreateSamplerState() failed.");
		...
		ThrowIfFailed(direct3DDevice->CreateSamplerState(&samplerStateDesc, ShadowMap.GetAddressOf()), "ID3D11Device::CreateSamplerState() failed.");
		...
		memcpy(samplerStateDesc.BorderColor, reinterpret_cast<FLOAT*>(&ShadowMapBorderColor), sizeof(FLOAT) * 4);
		ThrowIfFailed(direct3DDevice->CreateSamplerState(&samplerStateDesc, PcfShadowMap.GetAddressOf()), "ID3D11Device::CreateSamplerState() failed.");
	}
