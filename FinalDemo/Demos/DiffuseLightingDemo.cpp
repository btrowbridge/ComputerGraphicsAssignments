...
namespace Rendering
{
	...
	const XMFLOAT2 DiffuseLightingDemo::LightRotationRate = XMFLOAT2(XMConvertToRadians(500.0f), XMConvertToRadians(500.0f));

	DiffuseLightingDemo::DiffuseLightingDemo(Game& game) :
	...
	void DiffuseLightingDemo::ToggleGamePadControls()
	{
